...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'qybyyds2023@gmail.com',
  ...
  protectedRoutes: ['/Private', '/NSFW'],

  // [OPTIONAL] Use "" here if you want to remove this email address from the nav bar.
  email: 'qybyyds2023@gmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Qiuyebai-1226',
    },
  ],
